 ...
 * {@link product_like.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link product_like#newInstance} factory method to
 * create an instance of this fragment.
 */
public class product_like extends Fragment {
    ...
    public static product_like newInstance(String param1, String param2) {
        product_like fragment = new product_like();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest("http://"+getString(R.string.ip)+"/getlike?userid="+userid+"&type=product",
