package com.demo.cmnc.fragments.farm;
...
import static com.demo.cmnc.activities.one.FarmActivity.farm;
...
fab.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        if (userid.length() == 0) {
            ...
            startActivity(new Intent(getActivity(), JudgeActivity.class).putExtra("type", "farm").putExtra("farmname", farm));
        }
    }
});
        ...
        StringRequest stringRequest = new StringRequest("http://"+getString(R.string.ip)+"/getjudge_byfarm?farmname="+farm+"&type=farm",
