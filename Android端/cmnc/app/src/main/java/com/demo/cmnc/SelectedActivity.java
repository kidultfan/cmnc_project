            ...
            holder.itemView.setOnClickListener(new
                                                       View.OnClickListener() {
                                                           ...
                                                           public void onClick(View view) {
                                                               startActivity(new Intent(SelectedActivity.this,DetailsActivity.class).putExtra("title",product.getTitle()));
...
//            });
        ...
        public MyRecyclerAdapter.MyHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
            // 填充布局
            View view = LayoutInflater.from(mContext).inflate(R.layout.selected_item, null);
