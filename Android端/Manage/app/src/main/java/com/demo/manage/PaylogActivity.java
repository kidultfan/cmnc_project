...
myRecyclerAdapter=new MyRecyclerAdapter(this);
        ...
        getSupportActionBar().setTitle("查看订单");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

      String  url="http://"+getString(R.string.ip)+"/getpay?farm="+getIntent().getStringExtra("farm");
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i=0;i<jsonArray.length();i++){
                                ...
                                pay.setUserid(jsonObject.getString("userid"));
...
//            Glide.with(holder.imageView).load(product.ge)
            ...
            holder.userid.setText(pay.getUserid());
        ...
        class MyHolder extends RecyclerView.ViewHolder {
            ...
            private TextView title,time,price,userid;
